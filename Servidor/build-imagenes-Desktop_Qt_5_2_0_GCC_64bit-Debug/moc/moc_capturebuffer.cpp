...
#include "../../Servidor/capturebuffer.h"
...
void capturebuffer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->mostrar((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (capturebuffer::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&capturebuffer::mostrar)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void capturebuffer::mostrar(QImage _t1)
{
